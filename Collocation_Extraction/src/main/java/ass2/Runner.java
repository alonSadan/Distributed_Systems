...
public class Runner {
    ...
    public static void main(String[] args) throws IOException {
       ...
       // AWSCredentials credentials = new PropertiesCredentials(new File("C:\\Users\\alons\\.aws\\credentials"));
        ...
        final String jarname = "s3://ass2jar/collocation_extraction-yes-combiner-no-partition-jar-with-dependencies.jar";
        final String inputoutput = "AGAIN_yescombiner_no_partition/";

        final String ngramlocation = "s3://datasets.elasticmapreduce/ngrams/books/20090715/heb-all/2gram/data";

        HadoopJarStepConfig step1 = createJarStep(jarname, "ass2.C1Calculator"  , ngramlocation                                         , "s3://ass2jar/output1/" + inputoutput );
        ...
        RunJobFlowRequest runFlowRequest = new RunJobFlowRequest()
                .withName("YES_Combiner_NO_Partition-5.0")
